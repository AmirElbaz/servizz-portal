        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center justify-between gap-8">
              ...
              <div className="shrink-0 bg-white/15 backdrop-blur-md rounded-2xl p-3">
                <img src={project.logo} alt={project.name} className="h-12 lg:h-16 object-contain drop-shadow-2xl" />
              </div>
            </div>
          </div>
        </section>
